...
export default function Accounts() {
  ...
  const emailApiLine = (email: string) => email
                    ...
                    <>
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          placeholder={"++12025550101----https://xxx/api/sms/recordText?key=xxx\n++12025550101----https://xxx/api/sms/recordText?key=yyy"}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="https://relay.example.invalid/api/sms/recordText?key=xxx"
                          className="control-surface control-surface-compact w-full"
                        />
                      </div>
                    </>
              ...
              <tr key={acc.id} className="group border-b border-[var(--border)]/30 hover:bg-[var(--text-primary)]/[0.02] transition-colors cursor-pointer"
                ...
                <td className="px-3 py-2.5 font-mono text-sm text-[var(--text-primary)] align-top">
                  <div className="flex min-w-0 items-center gap-1.5">
                    ...
                    <button onClick={e => { e.stopPropagation(); copy(emailApiLine(acc.email)) }} title="复制 Email" className="text-[var(--text-muted)] hover:text-[var(--text-primary)] opacity-0 group-hover:opacity-100 transition-opacity"><Copy className="h-3 w-3" /></button>
                  </div>
