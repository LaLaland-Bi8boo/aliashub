...
def create_app(
    ...
    *,
    ...
    load_configured_env()
    app = Flask(__name__)
    # The standalone service is published below a dedicated reverse-proxy
    # prefix. Trust only the local proxy headers so Flask's generated static
    # URLs keep that prefix without changing the extractor's API routes.
